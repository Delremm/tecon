...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trial.category'
        db.alter_column(u'tecon_app_trial', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'], null=True))

    def backwards(self, orm):

        # Changing field 'Trial.category'
        db.alter_column(u'tecon_app_trial', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categories.Category']))
