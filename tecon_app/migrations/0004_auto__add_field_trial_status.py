...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.status'
        db.add_column(u'tecon_app_trial', 'status',
                      self.gf('model_utils.fields.StatusField')(default='users', max_length=100, no_check_for_status=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.status'
        db.delete_column(u'tecon_app_trial', 'status')
    ...
    models = {
        ...
        u'tecon_app.trial': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('model_utils.fields.StatusField', [], {'default': "'users'", 'max_length': '100', u'no_check_for_status': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }

    complete_apps = ['tecon_app']